        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <FeatureCard
              ...
              title="Partenariat"
            >
              Nous travaillons en étroite collaboration avec nos clients, agissant comme une extension de leur équipe
            ...
            <FeatureCard
              ...
              title="Résultats"
            >
              Nous optimisons vos processus, vos finances et vos équipes pour générer des gains concrets et durables.
              Chaque action vise à améliorer votre efficacité et votre croissance.
            </FeatureCard>
            <FeatureCard
              icon={
                <svg
